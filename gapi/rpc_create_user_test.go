...
import (
	...
	mockwk "github.com/rafaelvitoadrian/simplebank2/worker/mock"
...
func (expected eqCreateUserTxParamsMatcher) Matches(x interface{}) bool {
	...
	//kode ini dibuat untuk memangil afterCreate , karena di gomock tidak benar2 berkomunikasi dengan db, sementara aftercreatea akan dijaankan ketika transaksi dengan db asli
